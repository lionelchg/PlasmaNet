...
class ResNet(BaseModel):
    ...
    def forward(self, x):
        ...
        convN_4out = self.convN_4(convN_3out+torch.cat((convN_2out,torch.zeros_like(convN_2out)),dim=1))
        ...
        convN_9out = self.convN_9(torch.cat((convN_8out,torch.zeros_like(convN_8out)),dim=1)+convN_7out) 
