...
def plot_fig_scalar(X, Y, field, name, fig_name, colormap=default_cmap):
    ...
    plt.savefig('../../../datasets/Ekhi_test/figures/' + fig_name, bbox_inches='tight')
...
def plot_fig(X, Y, potential, physical_rhs, name='potential_2D', nit=0, no_rhs=False, colormap=default_cmap):
    ...
    plt.savefig('../../../datasets/Ekhi_test/figures/' + name + str(nit), bbox_inches='tight')
