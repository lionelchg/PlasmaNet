########################################################################################################################
#                                                                                                                      #
#                    2D Poisson datasets using random generation of rhs points with gaussian mask                      #
#                                                                                                                      #
...
def params(nits):
    ...
    for i in range(nits):
        ...
        yield f(x, y) * np.exp(-(X - x0)**2 / sigma**2 - (Y - y0)**2 / sigma**2)
...
if __name__ == '__main__':
    ...
    if args.case is not None:
        ...
        casename = f'{npts:d}x{npts}/random_{n_res:d}_center/'
